...
# Panel drawing lives in visualization/panels.py so the fingerprint card and these
# figures share one implementation -- analysis/ and visualization/ must not import
# from scripts/, and two copies of a scale-bar convention would drift.
from visualization.panels import (  # noqa: E402
    INSTANCE_COLORS,
    MU,
    NICE_BAR_UM,
    add_scale_bar,
